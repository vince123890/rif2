...
/**
 * "Fasilitas Pembiayaan" — its own tab in the fig's 9-tab rail, separate
 * from "Izin Usaha" (business-license). They used to share this page
 * before the tab rail was corrected to match the fig's actual split.
 */
